...
app.use('/auth', authRoutes); // For /auth/login compatibility
app.use('/users', userRoutes); // For /users endpoints
app.use('/students', studentRoutes); // For /students endpoints
app.use('/organizations', organizationRoutes);
app.use('/events', eventRoutes); // For /events
app.use('/admin', adminRoutes); // For /admin endpoints
app.use('/uploads', uploadRoutes); // For /uploads endpoints
app.use('/health', healthRoutes); // For /health endpoints
app.use('/email', emailVerificationRoutes); // For /email endpoints
app.use('/activities', activityRoutes); // For /activities endpoints
app.use('/analytics', analyticsRoutes); // For /analytics endpoints
app.use('/settings', settingsRoutes); // For /settings endpoints
app.use('/public', publicRoutes); // For /public/organizations/popular
app.use('/notifications', notificationRoutes); // For /notifications endpoints
